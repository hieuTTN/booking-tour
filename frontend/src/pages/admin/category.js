...
const AdminCateory = ()=>{
    ...
    useEffect(()=>{
        const getCategrory = async() =>{
            var response = await getMethod("http://localhost:8080/api/category/public/findAll");
            var list = await response.json();
            setItems(list)
        };
        getCategrory();
        const getCategroryType = async() =>{
            var response = await getMethod("http://localhost:8080/api/category/public/get-all-type-category");
            var list = await response.json();
            setItemsType(list)
        };
        getCategroryType();
    ...
    async function loadACategory(id){
        var response = await getMethod("http://localhost:8080/api/category/admin/findById?id="+id);
        var result = await response.json();
